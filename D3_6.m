...
% Load the images
RGB_Left = imread('LSJ.jpg');
IR_Left = imread('LDSJ.png');

RGB_Right = imread('RSJ.jpg');
IR_Right = imread('RDSJ.png');
...
fc_right = [ 601.730844251917690   581.887105857937970 ];
cc_right = [ 219.829047509894080   254.724905544805300 ];
...
fc_left = [ 532.882508835719590   531.795526354738400 ];
cc_left = [ 291.009409618044910   222.806112996766560 ];
...
Rot = [ -0.00860 0.69457 -0.02751 ]';
Rot_matrix = rotationVectorToMatrix(Rot);
Rot_matrix = inv(Rot_matrix);

Trans = [ -990.624923269488 7.77709577344268 301.422399148011 ]';
